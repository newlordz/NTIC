...
using StemPlatform.Domain.Entities.LMSContext;

namespace StemPlatform.Application.LMSContext.Commands
{
    ...
    {
        Microsoft.EntityFrameworkCore.DbSet<StemPlatform.Domain.Entities.StudentContext.Student> Students { get; }
