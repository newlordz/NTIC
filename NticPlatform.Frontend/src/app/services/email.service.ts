...
export class EmailService {
  ...
  sendPasswordResetEmail(toEmail: string, toName: string, ticket: string, newPassword: string): void {
    this.send(
      toEmail, toName,
      `Your Password Has Been Reset | NTIC Ghana`,
      `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:24px;">
        ...
        <div style="background:#f8fafc;padding:28px;border:1px solid #e2e8f0;border-top:none;border-radius:0 0 12px 12px;">
          ...
          <div style="background:#eff6ff;border:1px solid #93c5fd;border-radius:8px;padding:16px;margin:0 0 16px;">
            ...
            <p style="margin:0 0 4px;color:#1e3a8a;font-size:14px;">Access Ticket ID: <code style="background:#fff;padding:2px 8px;border-radius:4px;font-weight:700;letter-spacing:1px;">${ticket}</code></p>
            <p style="margin:0;color:#1e3a8a;font-size:14px;">Temporary Password / PIN: <code style="background:#fff;padding:2px 8px;border-radius:4px;font-weight:700;letter-spacing:1px;">${newPassword}</code></p>
          </div>
